...
public class Activity_Exercise extends AppCompatActivity implements ExerciseInterface {
    ...
    public void btn_breakfast_clicked(View view){
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act008");
        update_user_mark();
    }

    public void btn_lunch_clicked(View view){
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act005");
        update_user_mark();
    }

    public void btn_dinner_clicked(View view){
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act006");
        update_user_mark();
    }

    private void update_user_mark(){
        new HomeAPIFetcher(this).execute(API,"action=getMark&user_id="+user_id);
    }
    ...
    public void btn_sit_clicked(View view) {
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act000");
        update_user_mark();
    }

    public void btn_run_clicked(View view) {
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act001");
        update_user_mark();
    }

    public void btn_weight_clicked(View view) {
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act002");
        update_user_mark();
    }

    public void btn_cycling_clicked(View view) {
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act003");
        update_user_mark();
    }

    public void btn_yoga_clicked(View view) {
        new HomeAPIFetcher(this).execute(API,"action=newActivity&user_id="+user_id+"&action_id=act004");
        update_user_mark();
    }
